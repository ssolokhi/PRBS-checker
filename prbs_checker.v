module prbs_checker #(parameter c_LOCK_THRESHOLD = 31, parameter c_OPEN_THRESHOLD = 31) (
    ...
    reg [$clog2(c_LOCK_THRESHOLD)-1:0] r_lock_counter;
    ...
    begin
        case (r_current_state)
            OPEN:
            begin
                if (r_lock_counter < c_LOCK_THRESHOLD-1 && i_received_prbs_bit == r_expected_prbs_bit) 
                begin
                    r_error <= 1'b0;
                    r_lock_counter <= r_lock_counter + 1;
                end
