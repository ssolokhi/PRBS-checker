...
#include "VPrbsCheckerTopTb.h" // generated from verilating the SystemVeriolg file
...
int main(int argc, char **argv) {
    ...
    const std::unique_ptr<VPrbsCheckerTopTb> prbsCheckerTop{new VPrbsCheckerTopTb{verilatedContext.get()}};
